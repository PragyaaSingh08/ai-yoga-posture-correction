...
# --- Parameters ---
TIMESTEPS = 20  # number of frames per sequence
FEATURES = len(feature_cols)

# --- Reshape safely ---
total = len(X)
usable = (total // TIMESTEPS) * TIMESTEPS  # trim extra frames
X = X[:usable]
y = y[:usable]
...
y = y[:X.shape[0]]  # ensure same length
y = to_categorical(y)
...
MODEL_PATH = os.path.join(MODEL_DIR, "pose_lstm_model.h5")
