# =====================================================
# train_pose_lstm.py  ✅ Improved Version (Stable + Scaled + Stratified)
# =====================================================
...
# 6️⃣ Train Model
# =====================================================
EPOCHS = 60  # keep same for comparison
BATCH_SIZE = 16
...
plt.title("🌀 Confusion Matrix - LSTM Yoga Pose Classification")
plt.tight_layout()
plt.show()
...
MODEL_PATH = os.path.join(MODEL_DIR, "pose_lstm_model_stable.h5")
model.save(MODEL_PATH)
print(f"\n✅ Model saved at: {MODEL_PATH}")
print("✅ Training complete and results generated successfully!")
